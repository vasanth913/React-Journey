                    ...
                    return(
                        <div key={item.card.info.id} className="p-2 m-2 border-gray-300 border-b-2 text-left flex">
                            ...
                            <div className="relative w-[200px] h-[200px]">
                              ...
                              <button className="absolute shadow-lg bottom-3 left-10 w-28 h-12 mb-10 z-2 rounded-lg bg-white text-green-500 text-center font-bold">ADD<span className="font-bold text-lg px-1 text-center my-1">&#43;</span> </button>
                            </div>
